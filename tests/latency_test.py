...
def main():
    ...
    while True:
        ...
        data = ray.get(server.pull.remote('action7'))
    ...
    print("Average latency: {}".format(time_elapsed/count))
    ray.shutdown()
...
1: 0.024598275983964767
2: 0.05113630504398556
3: 0.08549115588734081
4: 0.13996550991580442
5: 0.16078030812990415
6: 0.21811747146057678
7: 0.3018750363177472
8: 0.359005859443596
9: 0.45076819661852124
10: 0.5470377824880502
"""